...
MEMORY
{
	...
	FLASH_AP       : origin = 0x00430000, length = 0x00030000
	FLASH          : origin = 0x00460000, length = 0x003A0000
	/*FLASH          : origin = 0x00450000, length = 0x003B0000	 needed more MEM for RUSSTBLES */
