...
/* File Name: UNITS.H						    							*/
/* 									    									*/
/* File Description:  With any sort of phsyical calculation units need to be*/
/* considered.  This header file defines the implementation of units in an  */
/* abstract way with a number assigned to each unit.   						*/
/*									    									*/
/****************************************************************************/
...
const int MASTER_UNITS_STR_R[]={
						0x100|	c_volume,				0x4F,0xA0,0x62,0x45,0x4D,'','',0,
								u_v_barrel,				'b','b','l','','','','',0,
								//	u_v_bbl_liq,			'b','b','l','','','','',0,
								//	u_v_gal,				'g','a','l','','','','',0,
								u_v_L,			    	0xBB,'','','','','','',0,
								...
								//	u_v_cf,					'f','t','3','','','','',0,
								//	u_v_ci,					'i','n','3','','','','',0,
								u_v_N_cm,				0x48,0xBC,'3','','','','',0,
								u_v_N_L,				0x48,0xBB,'','','','','',0,
								//	u_v_scf,				'S','c','f','','','','',0,
								u_v_hectoliter,			0xB4,0xBB,'','','','','',0,
								//	u_v_mscf,				'M','S','c','f','','','',0,

						0x100|	c_volumetric_flow,		0x4F,0x50,'','','','','',0,
									u_vfr_barrel_day,		'b','b','l','/',0x63,0x79,0xBF,0,
								//	u_vfr_Mgal_day,			'M','g','a','l','/','d','y',0,
								u_vfr_ML_day,			0x4D,0xBB,'/',0x63,0x79,0xBF,'',0,
								//	u_vfr_cf_day,			'c','f','/','d','y','','',0,
								u_vfr_cm_day,			0xBC,'3','/',0x63,0x79,0xBF,'',0,
								//	u_vfr_imp_gal_day,		'I','g','a','l','/','d','y',0,
								//	u_vfr_gal_day,			'g','a','l','/','d','y','',0,
								//	u_vfr_mscf_day,			'M','S','c','f','/','d','y',0,
								//	u_vfr_scf_day,			'S','c','f','/','d','y','',0,
								//	u_vfr_scf_sec,			'S','c','f','/','s','','',0,
								//	u_vfr_barrel_min,		'b','b','l','/','m','i','n',0,
								u_vfr_cm_min,			0xBC,'3','/',0xBC,0xB8,0xBD,'',0,
								//	u_vfr_cf_min,			'c','f','/','m','i','n','',0,
								//	u_vfr_imp_gal_min,		'I','g','l','/','m','i','n',0,
								//	u_vfr_gal_min,			'g','a','l','/','m','i','n',0,
								u_vfr_L_min,			0xBB,'/',0xBC,0xB8,0xBD,'','',0,
								//	u_vfr_scf_min,			'S','c','f','/','m','i','n',0,
								u_vfr_cm_hr,			0xBC,'3','/',0xC0,0x61,0x63,'',0,
								//	u_vfr_imp_gal_hr,		'I','g','a','l','/','h','r',0,
								u_vfr_N_cm_hr,			0x48,0xBC,'3','/',0xC0,'','',0,
								u_vfr_N_cm_sec,			0x48,0xBC,'3','/',0x63,'','',0,
								u_vfr_N_cm_day,			0x48,0xBC,'3','/',0x63,0x79,0xBF,0,
								u_vfr_N_L_hr,			0x48,0xBB,'/',0xC0,'','','',0,
								//	u_vfr_cf_hr,			'c','f','/','h','r','','',0,
								//	u_vfr_barrel_hr,		'b','b','l','/','h','r','',0,
								//	u_vfr_gal_hr,			'g','a','l','/','h','r','',0,
								u_vfr_L_hr,				0xBB,'/',0xC0,'','','','',0,
								//	u_vfr_gal_sec,			'g','a','l','/','s','','',0,
								u_vfr_L_sec,			0xBB,'/',0x63,'','','','',0,
								//	u_vfr_cf_sec,			'c','f','/','s','','','',0,
								u_vfr_cm_sec,			0xBC,'3','/',0x63,'','','',0,
								//	u_vfr_barrel_sec,		'b','b','l','/','s','','',0,
								//	u_vfr_imp_gal_sec,		'I','g','a','l','/','s','',0,

						0x100|	c_temperature,			0x54,0x45,0x4D,0xA8,'','','',0,
								u_temp_C,				0xDF,'C','','','','','',0,
								u_temp_F,				0xDF,'F','','','','','',0,
								u_temp_R,				0xDF,'R','','','','','',0,
								u_temp_K,				0x4B,'','','','','','',0,

						0x100|	c_concentration,		0x4B,0x4F,0x48,0xE1,'','','',0,
								u_conc_perc_solid_per_weight,	'%','','','','','','',0,
								u_conc_perc_solid_per_vol,		'%','','','','','','',0,
								u_conc_ppm,				0xBC,0xBB,0xBD,'-','1','','',0,
								u_conc_ppb,				0xBC,0xBB,0x70,0xE3,'-','1','',0,

						0x100|	c_frequency,			0xAB,0x61,0x63,0xBF,0x6F,0xBF,0x61,0,
								u_freq_hertz,			0xA1,0xE5,'','','','','',0,
								u_mfgr_specific_MHz,	0x4D,0xA1,0xE5,'','','','',0,

						0x100|	c_pressure,				0xE0,0x41,0x42,0xA7,'','','',0,
								u_p_atm,				0x61,0xBF,0xBC,'','','','',0,
								//	u_p_in_H2O_68F,			'i','n','H','2','O','6','8',0,
								//	u_p_in_Hg_0C,			'i','n','H','g','0','C','',0,
								//	u_p_ft_H2O_68F,			'f','t','H','2','O','6','8',0,
								//	u_p_mm_H2O_68F,			'm','m','H','2','O','6','8',0,
								...
								//	u_p_bar,				'b','','','','','','',0,
								//	u_p_mbar,				'm','b','','','','','',0,
								u_p_g_scm,				0xB4,'/','c',0xBC,'2','','',0,
								u_p_kg_scm,				0xBA,0xB4,'/','c',0xBC,'2','',0,
								u_p_Pa,					0xA8,0x61,'','','','','',0,
								u_p_kPa,				0xBA,0xA8,0x61,'','','','',0,
								u_p_torr,				't','o','r','r','','','',0,
								//	u_p_in_H2O_60F,			'i','n','H','2','O','6','0',0,
								//	u_p_cm_H2O_4C,			'c','m','H','2','O','4','C',0,
								//	u_p_m_H2O_4C,			'm','H','2','O','4','C','',0,
								//	u_p_cm_Hg_0C,			'c','m','H','g','0','C','',0,
								//	u_p_lbs_sf,				'p','s','f','','','','',0,
								u_p_hectoPa,			0xB4,0xA8,0x61,'','','','',0,
								//	u_p_psia,				'p','s','i','a','','','',0,
								u_p_kg_sm,				0xBA,0xB4,'/',0xBC,'2','','',0,
								//	u_p_ft_H2O_4C,			'f','t','H','2','O','4','C',0,
								//	u_p_ft_H2O_60F,			'f','t','H','2','O','6','0',0,
								//	u_p_m_Hg_0C,			'm','H','g','0','C','','',0,
								u_p_MPa,				0x4D,0xA8,0x61,'','','','',0,
								//	u_p_in_H2O_4C,			'i','n','H','2','O','4','C',0,
								//	u_p_mm_H2O_4C,			'm','m','H','2','O','4','C',0,

						0x100|	c_emf,					0x48,0x41,0xA8,0x50,'','','',0,
								u_emf_mV,				0xBC,0x42,'','','','','',0,
								u_emf_V,				0x42,'','','','','','',0,

						0x100|	c_current,				0x54,0x4F,0x4B,'','','','',0,
								u_cur_mA,				0xBC,0x41,'','','','','',0,

						0x100|	c_analytical,			0x41,0x48,0x41,0xA7,0xA5,0x54,'',0,
								u_ana_percent,			'%','','','','','','',0,
					u_mfgr_specific_perc_per_API_60F,	'%','/','A','P','I','','',0,
					u_mfgr_specific_perc_per_kgm3_15C,	'%','/',0xBA,0xB4,'/',0xBC,'3',0,

						0x100|	c_volume_per_volume,	' ',' ',' ','','','','',0, //R_UHOH
								u_vpv_volume_percent,	'%','','','','','','',0,

						0x100|	c_mass,					0x4D,0x41,0x43,0x43,0x41,'','',0,
								u_m_kg,					0xBA,0xB4,'','','','','',0,
								//	u_m_lbs,				'l','b','s','','','','',0,
								u_m_g,					0xB4,'','','','','','',0,
								u_m_metric_tons,		0xBF,'','','','','','',0,
								//	u_m_short_tons,			't','s','','','','','',0,
								//	u_m_long_tons,			't','l','','','','','',0,
								//	u_m_ounce,				'o','z','','','','','',0,

						0x100|	c_mass_flow,			0x4D,0x50,'','','','','',0,
								u_mfr_g_sec,			0xB4,'/','c','','','','',0,
								u_mfr_g_min,			0xB4,'/',0xBC,0xB8,0xBD,'','',0,
								u_mfr_g_hr,				0xB4,'/',0xC0,'','','','',0,
								u_mfr_kg_sec,			0xBA,0xB4,'/','c','','','',0,
								u_mfr_kg_min,			0xBA,0xB4,'/',0xBC,0xB8,0xBD,'',0,
								u_mfr_kg_hr,			0xBA,0xB4,'/',0xC0,'','','',0,
								u_mfr_kg_day,			0xBA,0xB4,'/',0x63,0x79,0xBF,'',0,
								u_mfr_metric_tons_min,	0xBF,'/',0xBC,0xB8,0xBD,'','',0,
								u_mfr_metric_tons_hr,	0xBF,'/',0xC0,'','','','',0,
								u_mfr_metric_tons_day,	0xBF,'/',0x63,0x79,0xBF,'','',0,
								//	u_mfr_lbs_sec,			'l','b','s','/','s','','',0,
								//	u_mfr_lbs_min,			'l','b','s','/','m','i','n',0,
								//	u_mfr_lbs_hr,			'l','b','s','/','h','r','',0,
								//	u_mfr_lbs_day,			'l','b','s','/','d','y','',0,
						...
						0x100|	c_mass_per_volume,		0xA8,0xA7,0x4F,0x54,0x48,'','',0,
								u_mpv_kg_cm,			0xBA,0xB4,'/',0xBC,'3','','',0,
								u_mpv_kg_cm_15C,		0xBA,0xB4,'/',0xBC,'3',0x43,0xA9,0,
								u_mpv_kg_cm_60F,		0xBA,0xB4,'/',0xBC,'3','6','0',0,
								u_mpv_deg_API,			0xDF,'A','P','I','','','',0,
								u_mpv_deg_API_60F,		0xDF,'A','P','I','6','0','F',0,
								u_mpv_deg_API_15C,		0xDF,'A','P','I','1','5','C',0,
								//	u_mpv_sg,				's','g','','','','','',0,
								...
								//	u_mpv_sg_60F,			's','g','6','0','F','','',0,
								//	u_mpv_g_cc,				'g','/','c','c','','','',0,
								u_mpv_g_mL,				0xB4,'/',0xBC,0xBB,'','','',0,
								u_mpv_g_L,				0xB4,'/',0xBB,'','','','',0,
								u_mpv_kg_L,				0xBA,0xB4,'/',0xBB,'','','',0,
								//	u_mpv_lbs_gal,			'l','b','s','/','g','a','l',0,
								//	u_mpv_lbs_cf,			'l','b','s','/','c','f','',0,
								//	u_mpv_lbs_ci,			'l','b','s','/','i','n','3',0,
								//	u_mpv_short_tons_cyard,	't','s','/','y','d','3','',0,

						0x100|	c_time,					0x42,0x50,0x45,0x4D,0xB1,'','',0,
								u_time_sec,				'c','','','','','','',0,
								u_time_min,				0xBC,0xB8,0xBD,'','','','',0,
								u_time_hr,				0xC0,'','','','','','',0,
								u_time_day,				0x63,0x79,0xBF,'','','','',0,
								u_mfgr_specific_ct,		'c','t','','','','','',0,

						0x100|	c_not_classified,		0x50,0x61,0xB7,0xBD,0x6F,0x65,'',0,
								u_ana_percent,			'%','','','','','','',0,
								u_mfgr_specific_bps,	'b','p','s','','','','',0,
								u_mfgr_specific_V_per_MHz,	0x42,'/',0x4D,0xA1,0xE5,'','',0,
