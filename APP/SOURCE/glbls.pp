...
#line 121
	...
	{ 
        ...
        RELAY1_REVERT.val       = 0;
        RELAY1_REVERT.vect      = (int*)0;
        RELAY1_REVERT.vect2     = (int*)0;
        RELAY2_REVERT.val       = 0;
        RELAY2_REVERT.vect      = (int*)0;
        RELAY2_REVERT.vect2     = (int*)0;
...
#line 1200
	...
	for (i=0;i<3;i++)
	{
		...
		VAR_Setup_Unit(&FC[i].GROSS_OIL, 46, 1000000000.0, 0.0, 1000000000.0, 0.0);
		...
		VAR_Setup_Unit(&FC[i].GROSS_WATER, 46, 1000000000.0, 0.0, 1000000000.0, 0.0);
		...
		VAR_Setup_Unit(&FC[i].GROSS_TOTAL, 46, 1000000000.0, 0.0, 1000000000.0, 0.0); 
