...
void API_VCF(FLOW_COMP* f, float* VCFw, float* VCFo)
{
	...
	if((f->T.unit == 33) || (f->T.unit == 34))
	{ 
		t = Convert(f->T.class, f->T.calc_unit, 33, f->T.calc_val, 0, f->T.aux);
	...
	{ 
		t = Convert(f->T.class, f->T.calc_unit, 32, f->T.calc_val, 0, f->T.aux);
