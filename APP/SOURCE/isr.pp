...
#line 26 "G:\workspace\EEA\V615\APP\SOURCE\INCLUDE\BRANCH.H"
...
void c_INT1(void)
{
	...
	p[0] = ((*((volatile char*) 0x090000C) & 0xFF)<<8) | (*((volatile char*) 0x090000B) & 0xFF);
	p[1] = ((*((volatile char*) 0x090000E) & 0xFF)<<8) | (*((volatile char*) 0x090000D) & 0xFF);
	p[2] = ((*((volatile char*) 0x0900010) & 0xFF)<<8) | (*((volatile char*) 0x090000F) & 0xFF);
	{asm("	pop		ST			");};
...
void c_INT3(void)
{
	...
	{ 
		FREQ_COUNTER  = *((volatile char*) 0x090000A) & 0xFF;
		FREQ_COUNTER  = FREQ_COUNTER <<  8;
		FREQ_COUNTER |= *((volatile char*) 0x0900009) & 0xFF;
		FREQ_COUNTER  = FREQ_COUNTER <<  8;
		FREQ_COUNTER |= *((volatile char*) 0x0900008) & 0xFF;
		FREQ_COUNTER  = FREQ_COUNTER <<  8;
		FREQ_COUNTER |= *((volatile char*) 0x0900007) & 0xFF;
	}
...
void c_TINT0(void)
{
	...
	{  
		...
		while((int*)p != (int*)0)							 
		{
			...
			List_Remove((LIST*)&LIST_TIMER0, (GENERIC*)p);	 
