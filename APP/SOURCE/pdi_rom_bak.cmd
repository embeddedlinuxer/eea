...
MEMORY
{
	...
	FLASH_CF       : origin = 0x0041FFFF, length = 0x00000001
	FLASH_INIT     : origin = 0x00420000, length = 0x00008FFF
	FLASH_FAST     : origin = 0x00428FFF, length = 0x00008000
	FLASH_AP       : origin = 0x00430FFF, length = 0x00020000
	FLASH          : origin = 0x00450FFF, length = 0x003AF001
...
SECTIONS
{
	"initialization_TOP"	> FLASH_INIT

	"application_vector" 	> APP_VECT
	...
	"initialization"	 	> FLASH_INIT
	"branch_table" 			> FLASH_INIT
	.cinit	  				> FLASH_INIT
